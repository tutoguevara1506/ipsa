...
public class CatPiezas implements Serializable {
    ...
    private String cod_pie, cod_ref, cod_equ, nom_pie, des_pie, nomequ, cod_cat, det_ima, vid_uti;

    public CatPiezas() {
    }

    public CatPiezas(String cod_pie, String cod_ref, String cod_equ, String nom_pie, String des_pie, String nomequ, String cod_cat, String det_ima, String vid_uti) {
